...
namespace Client.BankA {
    ...
    public interface IBankAOps {
        ...
        Client.BankA.Company getCompany(int company_id);
        ...
        [System.ServiceModel.TransactionFlowAttribute(System.ServiceModel.TransactionFlowOption.Allowed)]
        void editStock(Client.BankA.Order order);
    ...
    public partial class BankAOpsClient : System.ServiceModel.ClientBase<Client.BankA.IBankAOps>, Client.BankA.IBankAOps {
        ...
        public Client.BankA.Company getCompany(int company_id) {
        ...
        public void editStock(Client.BankA.Order order) {
